...
locals {
  ...
  k8s_version   = "1.30" # Desired version of Kubernetes. For available versions, see the documentation main page: https://cloud.yandex.com/en/docs/managed-kubernetes/concepts/release-channels-and-updates.
  sa_name       = "svm-k8s" # Service account name. It must be unique in a cloud.
